...
boardOut : {},
    getBoard : function(){
        ...
        this.fillCardArray();
        if(typeof this.boardOut.playerCards[0][0][0] !== 'undefined' && gameState.currentState.hideDealerCard) {this.boardOut.playerCards[0][0][0]="XX";console.log("drawing over first card!");}
